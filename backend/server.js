...
app.post('/api/solve', async (req, res) => {
  try {
    ...
    console.log('Generated embedding for problem');
    ...
    // 过滤相似度较高的条目（阈值设为0.1）
    const relevantEntries = similarEntries.filter(entry => entry.score > 0.1);
    console.log('Relevant entries after filtering:', relevantEntries.length);
